...
export default function FeaturesCard({title, description, Children}) {
    return (
        <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className=" group mb-12">
                ...
                <h4 className="mb-3 text-xl font-bold text-dark dark:text-white">
                    {title ? title : 'Premium Property Listings'}
                </h4>
                <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
                    {description ? description : 'Discover an array of hand-picked properties that meet the highest standards of luxury and comfort.'}
                </p>
